...
--
-- Host: localhost
-- Creato il: Apr 10, 2024 alle 18:44
...
(19, 'Il padrino', 'Mafia in America', '02:55:00', '1972-09-21', 2),
(20, 'Top Gun', 'Un pilota di caccia si innamora della propria bionda istruttrice, Charlotte Blackwood, e si crede responsabile della morte del copilota. L\'esperienza nel programma di formazione lo forza a crescere.', '01:50:00', '1986-09-25', 5);
...
--
ALTER TABLE `attori`
  MODIFY `id_attore` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT per la tabella `film`
--
ALTER TABLE `film`
  MODIFY `id_film` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT per la tabella `generi`
--
ALTER TABLE `generi`
  MODIFY `id_genere` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
